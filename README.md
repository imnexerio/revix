...
- Web/Dart: `lib/firebase_options.dart` (generated by FlutterFire CLI via `flutterfire configure`)

> ℹ️ This project initializes Firebase through `DefaultFirebaseOptions.currentPlatform` in Dart, not a `web/firebase-config.js` file.
