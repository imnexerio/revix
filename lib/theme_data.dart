...
final ThemeData defaultLightTheme = ThemeData(
  ...
  textTheme: const TextTheme(
    ...
    displaySmall:
    TextStyle(color: Color(0xFF388E3C), fontWeight: FontWeight.bold),
    headlineMedium:
    TextStyle(color: Color(0xFF2E7D32), fontWeight: FontWeight.w600),
    headlineSmall:
    TextStyle(color: Color(0xFF388E3C), fontWeight: FontWeight.w600),
    titleLarge:
    TextStyle(color: Color(0xFF1B5E20), fontWeight: FontWeight.w600),
...
final ThemeData seaLightTheme = ThemeData(
  ...
  textTheme: const TextTheme(
    ...
    headlineMedium:
    TextStyle(color: Color(0xFF1976D2), fontWeight: FontWeight.w600),
    headlineSmall:
    TextStyle(color: Color(0xFF2196F3), fontWeight: FontWeight.w600),
    titleLarge:
    TextStyle(color: Color(0xFF0D47A1), fontWeight: FontWeight.w600),
...
final ThemeData sunsetLightTheme = ThemeData(
  ...
  textTheme: const TextTheme(
    displayLarge:
    TextStyle(color: Color(0xFFE65100), fontWeight: FontWeight.bold),
    displayMedium:
    TextStyle(color: Color(0xFFF57C00), fontWeight: FontWeight.bold),
    displaySmall:
    TextStyle(color: Color(0xFFFF9800), fontWeight: FontWeight.bold),
    headlineMedium:
    TextStyle(color: Color(0xFFF57C00), fontWeight: FontWeight.w600),
    headlineSmall:
    TextStyle(color: Color(0xFFFF9800), fontWeight: FontWeight.w600),
    titleLarge:
    TextStyle(color: Color(0xFFE65100), fontWeight: FontWeight.w600),
...
final ThemeData purpleLightTheme = ThemeData(
  ...
  textTheme: const TextTheme(
    displayLarge:
    TextStyle(color: Color(0xFF4A148C), fontWeight: FontWeight.bold),
    displayMedium:
    TextStyle(color: Color(0xFF7B1FA2), fontWeight: FontWeight.bold),
    displaySmall:
    TextStyle(color: Color(0xFF9C27B0), fontWeight: FontWeight.bold),
    headlineMedium:
    TextStyle(color: Color(0xFF7B1FA2), fontWeight: FontWeight.w600),
    headlineSmall:
    TextStyle(color: Color(0xFF9C27B0), fontWeight: FontWeight.w600),
    titleLarge:
    TextStyle(color: Color(0xFF4A148C), fontWeight: FontWeight.w600),
...
final ThemeData earthLightTheme = ThemeData(
  ...
  textTheme: const TextTheme(
    ...
    displayMedium:
    TextStyle(color: Color(0xFF795548), fontWeight: FontWeight.bold),
    displaySmall:
    TextStyle(color: Color(0xFF8D6E63), fontWeight: FontWeight.bold),
    headlineMedium:
    TextStyle(color: Color(0xFF795548), fontWeight: FontWeight.w600),
    headlineSmall:
    TextStyle(color: Color(0xFF8D6E63), fontWeight: FontWeight.w600),
    titleLarge:
    TextStyle(color: Color(0xFF3E2723), fontWeight: FontWeight.w600),
...
final ThemeData defaultDarkTheme = ThemeData(
  ...
  colorScheme: ColorScheme.dark(
    ...
    primaryContainer: const Color(0xFF66BB6A),
    ...
    surfaceVariant: const Color(0xFF1B5E20).withOpacity(0.1),
    error: const Color(0xFFE57373),
    errorContainer: const Color(0xFF442727),
    onPrimary: const Color(0xFF002200),
    onPrimaryContainer: const Color(0xFFE8F5E9),
    onSecondary: const Color(0xFF002200),
    onSecondaryContainer: const Color(0xFFE8F5E9),
    onTertiary: Colors.white,
    onTertiaryContainer: const Color(0xFFE8F5E9),
    onSurface: const Color(0xFFA5D6A7),
    onBackground: const Color(0xFF81C784),
    onError: Colors.white,
    surfaceTint: const Color(0xFF43A047),
  ),
  elevatedButtonTheme: ElevatedButtonThemeData(
    style: ElevatedButton.styleFrom(
      elevation: 2,
  ...
  textTheme: const TextTheme(
    displayLarge:
    TextStyle(color: Color(0xFFA5D6A7), fontWeight: FontWeight.bold),
    displayMedium:
    TextStyle(color: Color(0xFF81C784), fontWeight: FontWeight.bold),
    displaySmall:
    TextStyle(color: Color(0xFF66BB6A), fontWeight: FontWeight.bold),
    headlineMedium:
    TextStyle(color: Color(0xFF81C784), fontWeight: FontWeight.w600),
    headlineSmall:
    TextStyle(color: Color(0xFF66BB6A), fontWeight: FontWeight.w600),
    titleLarge:
    TextStyle(color: Color(0xFFA5D6A7), fontWeight: FontWeight.w600),
...
final ThemeData seaDarkTheme = ThemeData(
  ...
  colorScheme: ColorScheme.dark(
    ...
    secondaryContainer: const Color(0xFF80DEEA),
    tertiary: const Color(0xFF4DD0E1),
    tertiaryContainer: const Color(0xFF26C6DA),
    surface: const Color(0xFF1E1E1E),
    background: const Color(0xFF121212),
    surfaceVariant: const Color(0xFF0D47A1).withOpacity(0.1),
    error: const Color(0xFFE57373),
    errorContainer: const Color(0xFF442727),
    onPrimary: const Color(0xFF000D1A),
    onPrimaryContainer: const Color(0xFFE1F5FE),
    onSecondary: const Color(0xFF000D1A),
    onSecondaryContainer: const Color(0xFFE1F5FE),
    onTertiary: Colors.white,
    onTertiaryContainer: const Color(0xFFE1F5FE),
    onSurface: const Color(0xFF81D4FA),
    onBackground: const Color(0xFF4FC3F7),
    onError: Colors.white,
  ...
  textTheme: const TextTheme(
    displayLarge:
    TextStyle(color: Color(0xFF81D4FA), fontWeight: FontWeight.bold),
    displayMedium:
    TextStyle(color: Color(0xFF4FC3F7), fontWeight: FontWeight.bold),
    displaySmall:
    TextStyle(color: Color(0xFF29B6F6), fontWeight: FontWeight.bold),
    headlineMedium:
    TextStyle(color: Color(0xFF4FC3F7), fontWeight: FontWeight.w600),
    headlineSmall:
    TextStyle(color: Color(0xFF29B6F6), fontWeight: FontWeight.w600),
    titleLarge:
    TextStyle(color: Color(0xFF81D4FA), fontWeight: FontWeight.w600),
...
final ThemeData sunsetDarkTheme = ThemeData(
  ...
  colorScheme: ColorScheme.dark(
    ...
    primaryContainer: const Color(0xFFFFA726),
    secondary: const Color(0xFFFFCC80),
    secondaryContainer: const Color(0xFFFFB74D),
    tertiary: const Color(0xFFFFA726),
    tertiaryContainer: const Color(0xFFFF9800),
    surface: const Color(0xFF1E1E1E),
    background: const Color(0xFF121212),
    surfaceVariant: const Color(0xFFE65100).withOpacity(0.1),
    error: const Color(0xFFE57373),
    errorContainer: const Color(0xFF442727),
    ...
    onSurface: const Color(0xFFFFB74D),
    onBackground: const Color(0xFFFFA726),
    onError: Colors.white,
  ...
  textTheme: const TextTheme(
    displayLarge:
    TextStyle(color: Color(0xFFFFB74D), fontWeight: FontWeight.bold),
    displayMedium:
    TextStyle(color: Color(0xFFFFA726), fontWeight: FontWeight.bold),
    displaySmall:
    TextStyle(color: Color(0xFFFF9800), fontWeight: FontWeight.bold),
    headlineMedium:
    TextStyle(color: Color(0xFFFFA726), fontWeight: FontWeight.w600),
    headlineSmall:
    TextStyle(color: Color(0xFFFF9800), fontWeight: FontWeight.w600),
    titleLarge:
    TextStyle(color: Color(0xFFFFB74D), fontWeight: FontWeight.w600),
...
final ThemeData purpleDarkTheme = ThemeData(
  ...
  colorScheme: ColorScheme.dark(
    ...
    primaryContainer: const Color(0xFFAB47BC),
    secondary: const Color(0xFFCE93D8),
    secondaryContainer: const Color(0xFFBA68C8),
    tertiary: const Color(0xFFAB47BC),
    tertiaryContainer: const Color(0xFF9C27B0),
    surface: const Color(0xFF1E1E1E),
    background: const Color(0xFF121212),
    surfaceVariant: const Color(0xFF4A148C).withOpacity(0.1),
    error: const Color(0xFFE57373),
    errorContainer: const Color(0xFF442727),
    onPrimary: const Color(0xFF1A001A),
    onPrimaryContainer: const Color(0xFFF3E5F5),
    onSecondary: const Color(0xFF1A001A),
    onSecondaryContainer: const Color(0xFFF3E5F5),
    onTertiary: Colors.white,
    onTertiaryContainer: const Color(0xFFF3E5F5),
    onSurface: const Color(0xFFBA68C8),
    onBackground: const Color(0xFFAB47BC),
    onError: Colors.white,
    surfaceTint: const Color(0xFF9C27B0),
  ),
  elevatedButtonTheme: ElevatedButtonThemeData(
    style: ElevatedButton.styleFrom(
      elevation: 2,
  ...
  textTheme: const TextTheme(
    displayLarge:
    TextStyle(color: Color(0xFFBA68C8), fontWeight: FontWeight.bold),
    displayMedium:
    TextStyle(color: Color(0xFFAB47BC), fontWeight: FontWeight.bold),
    displaySmall:
    TextStyle(color: Color(0xFF9C27B0), fontWeight: FontWeight.bold),
    headlineMedium:
    TextStyle(color: Color(0xFFAB47BC), fontWeight: FontWeight.w600),
    headlineSmall:
    TextStyle(color: Color(0xFF9C27B0), fontWeight: FontWeight.w600),
    titleLarge:
    TextStyle(color: Color(0xFFBA68C8), fontWeight: FontWeight.w600),
...
final ThemeData earthDarkTheme = ThemeData(
  ...
  colorScheme: ColorScheme.dark(
    ...
    secondaryContainer: const Color(0xFFA1887F),
    tertiary: const Color(0xFF8D6E63),
    tertiaryContainer: const Color(0xFF795548),
    surface: const Color(0xFF1E1E1E),
    background: const Color(0xFF121212),
    surfaceVariant: const Color(0xFF3E2723).withOpacity(0.1),
    error: const Color(0xFFE57373),
    errorContainer: const Color(0xFF442727),
    onPrimary: const Color(0xFF1A0F0D),
    onPrimaryContainer: const Color(0xFFEFEBE9),
    onSecondary: const Color(0xFF1A0F0D),
    onSecondaryContainer: const Color(0xFFEFEBE9),
    onTertiary: Colors.white,
    onTertiaryContainer: const Color(0xFFEFEBE9),
    onSurface: const Color(0xFFA1887F),
    onBackground: const Color(0xFF8D6E63),
    onError: Colors.white,
    surfaceTint: const Color(0xFF795548),
  ),
  elevatedButtonTheme: ElevatedButtonThemeData(
    style: ElevatedButton.styleFrom(
      elevation: 2,
  ...
  textTheme: const TextTheme(
    displayLarge:
    TextStyle(color: Color(0xFFA1887F), fontWeight: FontWeight.bold),
    displayMedium:
    TextStyle(color: Color(0xFF8D6E63), fontWeight: FontWeight.bold),
    displaySmall:
    TextStyle(color: Color(0xFF795548), fontWeight: FontWeight.bold),
    ...
    TextStyle(color: Color(0xFF795548), fontWeight: FontWeight.w600),
    titleLarge:
    TextStyle(color: Color(0xFFA1887F), fontWeight: FontWeight.w600),
    bodyLarge: TextStyle(color: Color(0xFF8D6E63)),
    bodyMedium: TextStyle(color: Color(0xFF795548)),
  ),
);

/// Custom MaterialColor swatches for our themes
