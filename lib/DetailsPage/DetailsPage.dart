...
class DetailsPageState extends State<DetailsPage> {
  ...
  final GlobalKey<_NavigationSidebarState> _sidebarKey = 
      GlobalKey<_NavigationSidebarState>();
...
// Private NavigationSidebar widget - only used within DetailsPage
...
class _NavigationSidebarState extends State<_NavigationSidebar>
  ...
  final GlobalKey<_NavigationSidebarState> _nestedSidebarKey = GlobalKey<_NavigationSidebarState>();
  ...
  @override
  void didUpdateWidget(_NavigationSidebar oldWidget) {
