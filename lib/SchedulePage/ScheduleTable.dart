  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        // Responsive grid of cards with animation
        AnimatedSwitcher(
          duration: const Duration(milliseconds: 500),
          child: GridView.builder(
            key: ValueKey<String?>(currentSortField),
            shrinkWrap: true,
            ...
            itemBuilder: (context, index) {
              ...
              // Create a unique key for each card based on its data
              final String cardKey = '${record['subject']}_${record['lecture_no']}_${record['subject_code']}';
